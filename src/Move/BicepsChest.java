...
public class BicepsChest extends Exercise {
	/*
	 * 1.1)wideCurl (1min) 1.2)hammerCurl (1min) 1.3)dragCurl (1min) 1.4)reverseCurl
	 * (1min) 1.5)straightCurl (1min) 2.1)valleyPress (1min) 2.2)standingUpwardFly
	 * (1min) 2.3)reverseWideBenchPress (1min) 2.4)lyingRegularFly (1min)
	...
	public BicepsChest() {
		...
		this.getMoveList().add("Standing Upward Fly");
